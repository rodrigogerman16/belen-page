    ...
    <div>
      <section className="my-14 text-gray-700 w-3/4 m-auto">
        <div className="text-center mb-20 md:max-w-xl lg:max-w-3xl mx-auto">
          ...
          <p className="mb-6 text-center pb-2 md:mb-12 md:pb-0">
          As a dance and flexibility teacher, i touched the lives of many students, inspiring them to embrace their love of dance and grow in their skills and confidence. Below are just a few of the experiences shared by them:
          </p>
        </div>
